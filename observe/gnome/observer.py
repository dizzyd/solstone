...
class Observer:
    ...
    def __init__(self, interval: int = 300):
        ...
        self.current_screencast_path = None  # Temp path (.webm.tmp) of current screencast
    ...
    async def initialize_screencast(self) -> bool:
        ...
        # Use .webm.tmp extension to avoid triggering file watchers until complete
        temp_path = str(day_dir / f"{time_part}.webm.tmp")
    ...
    async def finalize_screencast(self, temp_path: str, final_path: str):
        """
        Add monitor metadata to screencast and rename from .webm.tmp to final name.

        Args:
            temp_path: Temporary path with .webm.tmp extension
