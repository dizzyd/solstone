...
def search_insights(
    ...
    *,
    ...
    """Search journal insights. (Deprecated: use search_journal instead)"""
    return search_journal(query, limit, offset, day=day, topic=topic)
...
def search_transcripts(
    ...
    """Search transcripts. (Deprecated: use search_journal with topic filter instead)"""
    # Note: start_date/end_date not supported in unified index, use day filter
    return search_journal(query, limit, offset, day=day, topic="audio")
...
def search_events(
    ...
    *,
    ...
    """Search events. (Deprecated: use search_journal with topic='event' instead)"""
    # Note: start/end time filters not supported in unified index
    return search_journal(query, limit, offset, day=day, facet=facet, topic="event")
